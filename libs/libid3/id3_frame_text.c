...
unsigned int
id3_string_size(uint8_t encoding, const char* text)
{
    int length = 0;
...
char*
id3_string_decode(uint8_t encoding, const char* text)
{
    switch (encoding)
    {
        case ID3_ENCODING_ISO_8859_1:
 ...
 */
int
id3_set_encoding(struct id3_frame* frame, int8_t encoding)
{
    /* Type check */
...
uint8_t*
id3_encodeUTF8_to_UTF16_text(const char* str)
{
...
uint8_t*
id3_encodeUTF8_to_ASCII_text(const char* str)
{
 ...
 */
int
id3_set_text_utf8(struct id3_frame* frame, char* text)
{
    /* Type check */
    if (frame->fr_desc->fd_idstr[0] != 'T')
    {
 ...
 */
int
id3_set_text_utf16(struct id3_frame* frame, char* text)
{
    /* Type check */
    if (frame->fr_desc->fd_idstr[0] != 'T')
    {
 ...
 */
int
id3_set_text_wraper(struct id3_frame* frame, char* text, int id3_tag_mode)
{
    int result = -1;
 ...
 */
char*
id3_get_comment(struct id3_frame* frame)
{
    int offset;
    /* Type check */
 ...
 */
int
id3_set_comment(struct id3_frame* frame, char* description, char* comment)
{
    /* Type check */
 ...
 */
int
id3_set_text__performer(struct id3_frame* frame, char* text)
{
    // Type check
    if (frame->fr_desc->fd_idstr[0] != 'T')
    {
 ...
 */
int
id3_set_text__performer_utf8(struct id3_frame* frame, char* text)
{
    // Type check
    if (frame->fr_desc->fd_idstr[0] != 'T')
    {
 ...
 */
int
id3_set_text__performer_UTF16(struct id3_frame* frame, char* text)
{
    // Type check
    if (frame->fr_desc->fd_idstr[0] != 'T')
    {
 ...
 */
int
id3_set_text__performer_wraper(struct id3_frame* frame, char* text, int id3_tag_mode)
{
    int result = -1;
