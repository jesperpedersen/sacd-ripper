...
static size_t
utf16_strlen(const unsigned char* string)
{
    size_t len = 0;
...
char*
convert_from_utf16(const unsigned char* utf16)
{
    return charset_convert(utf16, utf16_strlen(utf16), "UTF-16", NULL);
}

char*
convert_from_utf16be(const unsigned char* utf16)
{
...
static char*
to_ascii(const unsigned char* utf16, int le)
{
    char* ascii;
