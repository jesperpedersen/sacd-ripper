...
void
buffer_pool_create(buffer_pool_t* pool, size_t size, int limit)
{
...
buffer_pool_space_t*
buffer_pool_get_space(buffer_pool_t* pool)
{
...
/* increment the use count to require one more drop before returning this space
   to the pool */
void
buffer_pool_use_space(buffer_pool_space_t* space)
{
    possess(space->use);
...
void
buffer_pool_drop_space(buffer_pool_space_t* space)
{
    int use;
    buffer_pool_t* pool;
...
int
buffer_pool_free(buffer_pool_t* pool)
{
    int count;
    buffer_pool_space_t* space;
