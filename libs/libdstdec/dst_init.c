...
static void*
MemoryAllocate(int NrOfElements, int SizeOfElement)
{
    void* Array;
...
/* General function for allocating memory for array of any type */
static void*
AllocateArray(int Dim, int ElementSize, ...)
{
...
int
DST_InitDecoder(ebunch* D, int NrOfChannels, int SampleRate)
{
    int retval = 0;
