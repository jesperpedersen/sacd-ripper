...
void
twist(lock* bolt, enum twist_op op, long val)
{
    int ret;
...
void
wait_for(lock* bolt, enum wait_op op, long val)
{
    int ret;
...
thread*
launch(void (*probe)(void*), void* payload)
{
    int ret;
    thread* th;
