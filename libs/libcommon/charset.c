...
char*
charset_convert(const char* string, size_t insize, const char* from, const char* to)
{
...
char*
charset_from_utf8(const char* string)
{
    if (!string)
    {
        return NULL;
...
char*
charset_to_utf8(const char* string)
{
    if (!string)
    {
        return NULL;
