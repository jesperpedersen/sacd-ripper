...
buf_write(pb_ostream_t* stream, const uint8_t* buf, size_t count)
{
...
pb_ostream_t
pb_ostream_from_buffer(uint8_t* buf, size_t bufsize)
{
    pb_ostream_t stream;
...
bool checkreturn
pb_write(pb_ostream_t* stream, const uint8_t* buf, size_t count)
{
 ...
 */
static bool checkreturn
encode_array(pb_ostream_t* stream, const pb_field_t* field,
...
bool checkreturn
pb_encode(pb_ostream_t* stream, const pb_field_t fields[], const void* src_struct)
{
...
/* Helper functions */
bool checkreturn
pb_encode_varint(pb_ostream_t* stream, uint64_t value)
{
    uint8_t buffer[10];
    int i = 0;
...
bool checkreturn
pb_encode_tag(pb_ostream_t* stream, pb_wire_type_t wiretype, int field_number)
{
...
bool checkreturn
pb_encode_tag_for_field(pb_ostream_t* stream, const pb_field_t* field)
{
...
bool checkreturn
pb_encode_string(pb_ostream_t* stream, const uint8_t* buffer, size_t size)
{
    if (!pb_encode_varint(stream, size))
    {
        return false;
 ...
 */
static void
endian_copy(void* dest, const void* src, size_t destsize, size_t srcsize)
{
...
bool checkreturn
pb_enc_varint(pb_ostream_t* stream, const pb_field_t* field, const void* src)
{
    uint64_t value = 0;
...
bool checkreturn
pb_enc_svarint(pb_ostream_t* stream, const pb_field_t* field, const void* src)
{
    uint64_t value = 0;
    uint64_t zigzagged;
...
bool checkreturn
pb_enc_fixed64(pb_ostream_t* stream, const pb_field_t* field, const void* src)
{
    #ifdef __BIG_ENDIAN__
    uint8_t bytes[8] = {0};
    memcpy(bytes, src, 8);
...
bool checkreturn
pb_enc_fixed32(pb_ostream_t* stream, const pb_field_t* field, const void* src)
{
    #ifdef __BIG_ENDIAN__
    uint8_t bytes[4] = {0};
    memcpy(bytes, src, 4);
...
bool checkreturn
pb_enc_bytes(pb_ostream_t* stream, const pb_field_t* field, const void* src)
{
...
bool checkreturn
pb_enc_string(pb_ostream_t* stream, const pb_field_t* field, const void* src)
{
    return pb_encode_string(stream, (uint8_t*)src, strlen((char*)src));
}

bool checkreturn
pb_enc_submessage(pb_ostream_t* stream, const pb_field_t* field, const void* src)
{
