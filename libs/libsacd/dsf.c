...
static int
dsf_create_header(scarletbook_output_format_t* ft)
{
...
static int
dsf_create(scarletbook_output_format_t* ft)
{
    dsf_handle_t* handle = (dsf_handle_t*)ft->priv;
...
static int
dsf_close(scarletbook_output_format_t* ft)
{
    dsf_handle_t* handle = (dsf_handle_t*)ft->priv;
    scarletbook_handle_t* sb_handle = ft->sb_handle;
    int i;
...
static int
dsf_write_frame(scarletbook_output_format_t* ft, const uint8_t* buf, size_t len)
{
    dsf_handle_t* handle = (dsf_handle_t*) ft->priv;
