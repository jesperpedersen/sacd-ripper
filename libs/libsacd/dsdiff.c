...
static char*
get_mtoc_title_text(scarletbook_handle_t* handle)
{
...
static uint8_t*
add_marker_chunk(uint8_t* em_ptr, scarletbook_output_format_t* ft, uint64_t frame_count, uint16_t mark_type, uint16_t track_flags)
{
...
static int
calculate_header_and_footer(scarletbook_output_format_t* ft)
{
...
static int
dsdiff_create_edit_master(scarletbook_output_format_t* ft)
{
    int ret;
    dsdiff_handle_t* handle = (dsdiff_handle_t*) ft->priv;
...
static int
dsdiff_create(scarletbook_output_format_t* ft)
{
...
static int
dsdiff_close(scarletbook_output_format_t* ft)
{
    dsdiff_handle_t* handle = (dsdiff_handle_t*) ft->priv;
...
static int
dsdiff_write_frame(scarletbook_output_format_t* ft, const uint8_t* buf, size_t len)
{
    dsdiff_handle_t* handle = (dsdiff_handle_t*) ft->priv;
...
scarletbook_format_handler_t const*
dsdiff_format_fn(void)
{
...
scarletbook_format_handler_t const*
dsdiff_edit_master_format_fn(void)
{
    static scarletbook_format_handler_t handler =
    {
