...
static int
dst_decoder_thread_create(dst_decoder_thread_t decoder, int spu_id, sys_event_queue_t recv_queue)
{
...
static int
dst_decoder_thread_destroy(dst_decoder_thread_t decoder)
{
...
static int
dst_decoder_wait(dst_decoder_t* dst_decoder, int timeout)
{
    sys_event_t event;
    int ret;
    int errors = 0;
...
static void
process_dst_frames(dst_decoder_t* dst_decoder)
{
...
dst_decoder_t*
dst_decoder_create(int channel_count, frame_decoded_callback_t frame_decoded_callback, frame_error_callback_t frame_error_callback, void* userdata)
{
    sys_event_queue_attr_t queue_attr;
...
int
dst_decoder_destroy(dst_decoder_t* dst_decoder)
{
    int ret, i;
...
int
dst_decoder_decode(dst_decoder_t* dst_decoder, uint8_t* dst_data, size_t dst_size)
{
    int ret;
